...
if __name__ == '__main__':
    # Configuration
    DATA_DIR = '/home/humair/ml/MNIST-JPG/MNIST Dataset JPG format/MNIST - JPG - testing'  # Directory containing subdirectories of digit classes
    USE_PICKLE = True  # Set to False to process images from directories
    PICKLE_PATH = "/home/humair/ml/diget_processed.pkl"  # Path to pickle file if USE_PICKLE is True
